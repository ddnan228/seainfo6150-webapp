...
const Article = () => {
  return (
    ...
    <header>
      ...
      <p><i>by Kate Farley (<a href="mailto:(kate.farley@nytimes.com)">kate.farley@nytimes.com</a>)</i><br />
      <time dataTime = "2018-11-22">November 22, 2018</time></p>
    </header>
    <main>
      ...
      <p>"<i>Although it is not one of the most difficult things we have ever moved,</i>" says Douglas Phelps, who oversaw the relocation of the torch, "<i>it is certainly the most important.</i>"</p>

      <h2>The history of the Statue of Liberty</h2>

      <p>Not only is the Statue of Liberty the symbol of New York City, she is also a UNESCO World Heritage site under the designation of <i>_Outstanding Universal Value_</i>.</p>
      ...
      <blockquote><b><i>"Give me your tired, your poor<br />Your huddled masses yearning to breathe free."</i></b></blockquote>
      ...
      <ul>
        ...
        <li> Total weight of the Statue of Liberty is <b>225 tons</b> (or <b>450,000 pounds</b>)</li>
      </ul>
    </main>
    </article>
  )
